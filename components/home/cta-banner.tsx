...
export function CTABanner() {
  return (
    <section className="bg-[#1a2744] py-8 sm:py-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 text-center sm:text-left">
        ...
        <Link 
          ...
          className="bg-[#4ade80] hover:bg-[#22c55e] text-[#1a2744] px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-medium transition-colors whitespace-nowrap text-sm sm:text-base flex items-center gap-2"
        >
